...
if __name__ == "__main__":
	...
	app = er.EwApp("Espace", SCREEN_WIDTH, SCREEN_HEIGHT, 300)
	...
	class Enemy(er.EwRect):
		...
		def __init__(self):
			...
			er.EwRect.__init__(self, randrange(8, SCREEN_WIDTH-w), -randrange(h, DISTANCE_LIMIT), w, h, c, 0)
	...
	class Raid:
		...
		def __init__(self, spawn_number):
			
			self.spawn = [Enemy() for x in range(1, spawn_number)]
